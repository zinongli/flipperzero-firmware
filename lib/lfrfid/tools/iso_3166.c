...
// Array of ISO 3166-1 countries
const ISO3166Country iso_3166_countries[ISO_3166_COUNTRY_COUNT] = {
...
ISO3166Country iso_3166_find_country_by_code(uint16_t code) {
    for (int i = 0; i < ISO_3166_COUNTRY_COUNT; i++) {
        if (iso_3166_countries[i].code == code) {
            return iso_3166_countries[i];
        }
    }
